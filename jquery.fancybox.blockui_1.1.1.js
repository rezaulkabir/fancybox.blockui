					...
					blockUI: function(params) {
									...
									if (fancyboxBlockUI.m_messageType != 'none') {
										...
										if (fancyboxBlockUI.m_html) {
											...
											$('#messagebox_'+fancyboxBlockUI.m_messageType).html(fancyboxBlockUI.m_html);	
										}
										
										fancyboxBlockUI.m_html = $('#messagebox_'+fancyboxBlockUI.m_messageType).parent().html();
									}
